...
def execute_query(sql_server_connection,oracle_connection,sql_query,oracle_query):
    print("Test")
    ...
    print(oracle_conn)
    # query=""
    sql_df=pd.read_sql_query(sql_query,sql_conn)
    oracle_df=pd.read_sql_query(oracle_query,oracle_conn)
    print(sql_df)
    print(oracle_df)
